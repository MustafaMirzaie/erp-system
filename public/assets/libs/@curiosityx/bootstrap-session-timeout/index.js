! function(a) {
    ...
    a.sessionTimeout = function(b) {
        ...
        var g, h = {
                title: "نشست شما به اتمام می‌رسد!",
                message: "نشست شما به اتمام می‌رسد.",
                logoutButton: "خروج",
                keepAliveButton: "ادامه اتصال",
            ...
            i = h,
            j = {};
        if (b && (i = a.extend(h, b)), i.warnAfter >= i.redirAfter) return console.error('افزونه Bootstrap-session-timeout بدرستی پیکربندی نشده است. گزینه "redirAfter" باید برابر یا بزرگتر از "warnAfter" باشد.'), !1;
