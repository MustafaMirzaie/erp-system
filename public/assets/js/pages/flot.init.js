function getChartColorsArray(t) {
    ...
    t.prototype.createPlotGraph = function(t, a, o, e, r, l, i, n) {
        ...
        t && this.createPlotGraph("#website-stats", [
            ...
            [5, 80],
            [6, 200]
        ], ["دسکتاپ", "لپ تاپ", "تبلت"], t, "rgba(166, 176, 207, 0.1)", "transparent");
        var a = getChartColorsArray("pie-chart-container");
        a && this.createPieGraph("#pie-chart #pie-chart-container", ["دسکتاپ", "لپ تاپ", "تبلت"], [20, 30, 15], a);
        ...
        r && ((o = this.createRealTimeGraph("#flotRealTime", this.randomData(), r)).draw(), e = this),
            ...
            }(), getChartColorsArray("donut-chart-container") && this.createDonutGraph("#donut-chart #donut-chart-container", ["دسکتاپ", "لپ تاپ", "تبلت"], [29, 20, 18], ["#f0f1f4", "#556ee6", "#34c38f"])
