var url = "assets/json/",
    ...
    getJSON = function(t, a) {
        ...
        e.open("GET", url + t, !0), e.responseType = "json", e.onload = function() {
            var t = e.status;
...
function loadJobListData(t) {
    ...
    }), $(".dataTables_paginate").addClass("pagination-rounded"), $(".dataTables_filter").hide()
}
...
getJSON("job-list.json", function(t, a) {
    null !== t ? console.log("Something went wrong: " + t) : loadJobListData(allJobList = a)
});
var date = new Date,
...
function filterData() {
    ...
    $.fn.DataTable.isDataTable("#job-list") && $("#job-list").DataTable().destroy(), loadJobListData(t)
}
document.querySelector("#datepicker1 input") && $("#datepicker1 input").datepicker("setDate", today);