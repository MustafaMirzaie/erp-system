...
const convertPersianDate = (data) => {
  const convertData =  moment(data, 'MM/DD/YYYY').locale('fa').format('jMMMM jDD');
  return convertData
}
...
statisticsApplicationColors && (options = {
    ...
    labels: [ convertPersianDate('02/02/2022'),convertPersianDate('05/01/2022') , convertPersianDate("03/01/2022"), convertPersianDate("04/01/2022"), convertPersianDate("05/01/2022"), convertPersianDate("06/01/2022"), convertPersianDate("07/01/2022"), convertPersianDate("08/01/2022"), convertPersianDate("09/01/2022"), convertPersianDate("10/01/2022"), convertPersianDate("11/01/2022")],
    ...
    tooltip: {
        ...
        y: {
            formatter: function(e) {
                return void 0 !== e ? e.toFixed(0) + " نکته" : e
            }
        }
    }
...
ApplicationReveicedTimeColors && (options = {
    ...
    labels: ["8 ظ", "9 ظ", "10 ظ", "11 ظ", "12 ظ", "1 ص", "2 ص", "3 ص", "4 ص"],
    dataLabels: {
        enabled: !1
    },
