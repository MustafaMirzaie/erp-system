! function (s) {
    ...
    function c(e) {
        if (1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e) {
            s("html").removeAttr("dir");
            s("#dark-mode-switch, #rtl-mode-switch, #dark-rtl-mode-switch").prop("checked", !1);
        ...
        } else if (1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e) {
            s("html").removeAttr("dir");
            s("#light-mode-switch, #rtl-mode-switch, #dark-rtl-mode-switch").prop("checked", !1);
            s("html").attr("data-bs-theme", "dark");
            s("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css");
            s("#app-style").attr("href", "assets/css/app.min.css");
            sessionStorage.setItem("is_visited", "dark-mode-switch");
        } else if (1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e) {
            s("#light-mode-switch, #dark-mode-switch, #dark-rtl-mode-switch").prop("checked", !1);
            s("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css");
            s("#app-style").attr("href", "assets/css/app-rtl.min.css");
            s("html").attr("dir", "rtl");
            s("html").attr("data-bs-theme", "light");
            sessionStorage.setItem("is_visited", "rtl-mode-switch");
        } else if (1 == s("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e) {
            s("#light-mode-switch, #rtl-mode-switch, #dark-mode-switch").prop("checked", !1);
            s("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css");
            s("#app-style").attr("href", "assets/css/app-rtl.min.css");
            s("html").attr("dir", "rtl");
            s("html").attr("data-bs-theme", "dark");
    ...
    s("#side-menu").metisMenu(), s("#vertical-menu-btn").on("click", function (e) {
        ...
        window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) ?
            (s(".right-bar input:checkbox").prop("checked", !1), s("#" + e).prop("checked", !0), c(e)) :
            "rtl" === s("html").attr("dir") && "dark" === s("html").attr("data-bs-theme") ?
                (s("#dark-rtl-mode-switch").prop("checked", !0), s("#light-mode-switch").prop("checked", !1),
                    sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"), c("dark-rtl-mode-switch")) :
                "rtl" === s("html").attr("dir") ?
                    (s("#rtl-mode-switch").prop("checked", !0), s("#light-mode-switch").prop("checked", !1),
                        sessionStorage.setItem("is_visited", "rtl-mode-switch"), c("rtl-mode-switch")) :
                    "dark" === s("html").attr("data-bs-theme") ?
                        (s("#dark-mode-switch").prop("checked", !0), s("#light-mode-switch").prop("checked", !1),
                            sessionStorage.setItem("is_visited", "dark-mode-switch"), c("dark-mode-switch")) :
                        (s("#rtl-mode-switch").prop("checked", !0), s("#light-mode-switch").prop("checked", !1),
                            sessionStorage.setItem("is_visited", "rtl-mode-switch"), c("rtl-mode-switch")));
